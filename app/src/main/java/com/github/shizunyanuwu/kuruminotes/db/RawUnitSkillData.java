...
import com.github.shizunyanuwu.kuruminotes.data.Chara;
...
public class RawUnitSkillData {
    ...
    // JP/CN Database
    public int main_skill_evolution_1_pro;
    public int sp_skill_evolution_1_pro;
    ...
    public void setCharaSkillList(Chara chara){
        ...
        if(main_skill_revolution_1 != 0) // Ninon Database
            chara.getSkills().add(new Skill(main_skill_revolution_1, Skill.SkillClass.MAIN1_REVO));
        if(main_skill_evolution_1_pro != 0) // JP/CN Database
            chara.getSkills().add(new Skill(main_skill_evolution_1_pro, Skill.SkillClass.MAIN1_EVO_PRO));
        if(main_skill_2 != 0)
        ...
        if(main_skill_revolution_2 != 0) // Ninon Database
        ...
        if(sp_skill_revolution_1 != 0) // Ninon Database
            chara.getSkills().add(new Skill(sp_skill_revolution_1, Skill.SkillClass.SP1_REVO));
        if(sp_skill_evolution_1_pro != 0) // JP/CN Database
            chara.getSkills().add(new Skill(sp_skill_evolution_1_pro, Skill.SkillClass.SP1_EVO_PRO));
        if(sp_skill_2 != 0)
        ...
        if(sp_skill_revolution_2 != 0) // Ninon Database
