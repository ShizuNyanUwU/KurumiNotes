...
import com.github.shizunyanuwu.kuruminotes.utils.FileUtils
    ...
    private fun cursor2RawUnitSkillDataList(cursor: Cursor): List<RawUnitSkillData>? {
        ...
        try {
            while (cursor.moveToNext()) {
                ...
                val isNinonDB = UserSettings.get().getUserServer() == UserSettings.SERVER_JP_NINON // Check db server
                if (isNinonDB) { // Ninon Database
                    ...
                    bean.main_skill_evolution_1_pro = cursor.getInt(RawUnitSkillData::main_skill_evolution_1_pro.name)
                    bean.sp_skill_evolution_1_pro = cursor.getInt(RawUnitSkillData::sp_skill_evolution_1_pro.name)
                }
    ...
    private fun cursor2RawSkillDataList(cursor: Cursor): List<RawSkillData>? {
        ...
        try {
            while (cursor.moveToNext()) {
                ...
                bean.action_11 = cursor.getInt(RawSkillData::action_11.name)
                bean.action_12 = cursor.getInt(RawSkillData::action_12.name)
                bean.action_13 = cursor.getInt(RawSkillData::action_13.name)
                bean.action_14 = cursor.getInt(RawSkillData::action_14.name)
                bean.action_15 = cursor.getInt(RawSkillData::action_15.name)
                bean.action_16 = cursor.getInt(RawSkillData::action_16.name)
                bean.action_17 = cursor.getInt(RawSkillData::action_17.name)
                bean.action_18 = cursor.getInt(RawSkillData::action_18.name)
                bean.action_19 = cursor.getInt(RawSkillData::action_19.name)
                bean.action_20 = cursor.getInt(RawSkillData::action_20.name)
                ...
                bean.depend_action_11 = cursor.getInt(RawSkillData::depend_action_11.name)
                bean.depend_action_12 = cursor.getInt(RawSkillData::depend_action_12.name)
                bean.depend_action_13 = cursor.getInt(RawSkillData::depend_action_13.name)
                bean.depend_action_14 = cursor.getInt(RawSkillData::depend_action_14.name)
                bean.depend_action_15 = cursor.getInt(RawSkillData::depend_action_15.name)
                bean.depend_action_16 = cursor.getInt(RawSkillData::depend_action_16.name)
                bean.depend_action_17 = cursor.getInt(RawSkillData::depend_action_17.name)
                bean.depend_action_18 = cursor.getInt(RawSkillData::depend_action_18.name)
                bean.depend_action_19 = cursor.getInt(RawSkillData::depend_action_19.name)
                bean.depend_action_20 = cursor.getInt(RawSkillData::depend_action_20.name)
