...
import com.github.shizunyanuwu.kuruminotes.ui.base.BackgroundSpan
import com.github.shizunyanuwu.kuruminotes.common.I18N
import com.github.shizunyanuwu.kuruminotes.common.Statics
import com.github.shizunyanuwu.kuruminotes.data.action.ActionParameter
import com.github.shizunyanuwu.kuruminotes.data.action.ActionRaw
import com.github.shizunyanuwu.kuruminotes.data.action.SummonAction
import com.github.shizunyanuwu.kuruminotes.db.DBHelper
import com.github.shizunyanuwu.kuruminotes.db.DBInfo
    ...
    enum class SkillClass(val value: String) {
        ...
        fun description(): String {
            return when (this) {
                ...
                MAIN1_EVO_PRO ->
                    I18N.getStringWithSpace(R.string.main_skill_1_evo_pro)
                MAIN2_EVO ->
                ...
                SP1_EVO_PRO ->
                    I18N.getStringWithSpace(R.string.sp_skill_1_evo_pro)
                SP2 ->
